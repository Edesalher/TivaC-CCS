...
//int tama�o_del_array;
//int tama�o_del_tipo_de_dato;
//char buffer[10];
...
//         tama�o_del_array = sizeof(cuenta);
//         tama�o_del_tipo_de_dato = sizeof(char);
//         cantidad_elementos = (tama�o_del_array / tama�o_del_tipo_de_dato);
